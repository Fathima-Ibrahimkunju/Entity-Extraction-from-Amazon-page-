# -*- coding: utf-8 -*-
"""Amazon_laptops_version_2

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1m_Kme8Ygem38QUlfaWczCg-xRr9aqMO1
"""
...
if __name__ == '__main__':
    ...
    urls = []
    for r in pages:
        url = 'https://www.amazon.in/s?k=laptops&i=computers&rh=n%3A1375424031&page='+str(r)
        urls.append(url)
    for i in urls:
        ...
        laptop_df = pd.DataFrame.from_dict(d)
...
laptop_df.to_csv('laptop1.csv', encoding = 'utf-8-sig') 
files.download('laptop1.csv')

# Creating json format
from google.colab import files
laptop_df.to_json('laptop1.json') 
files.download('laptop1.json')
