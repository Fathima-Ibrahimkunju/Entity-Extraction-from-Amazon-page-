...
Original file is located at
    https://colab.research.google.com/drive/1z6v4roKy6P_9n6WAkVaRqt6WN9eR9l5D
"""
...
if __name__ == '__main__':
  ...
  d = {'Name': [], 'Price': [], 'Rating': [], 'Number of rating': [], 'Brand': [], 'Model': [], 'Colour': [], 'Headphones form factor': [], 'Connector type': []}
  urls = []
  for r in pages:
  ...
  for i in urls:
    ...
    earpod_df = pd.DataFrame.from_dict(d)
