# -*- coding: utf-8 -*-
"""Amazon_mixer_grinder

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1FmMCYPj9L0G5EAqGbI0aTluS9SCdJtNH
"""
...
if __name__ == '__main__':
    ...
    d = {'Name':[], 'Price':[], 'Rating':[], 'Number of rating':[], 'Brand':[], 'Model':[], 'Material':[], 'Blade Material':[], 'Colour':[], 'Number of speeds':[], 'Product Dimensions':[], 'Voltage':[], 'Wattage':[], 'Item Weight':[]}
    urls = []
    for r in pages:
    ...
    for i in urls:
        ...
        Mixer_grinder_df = pd.DataFrame.from_dict(d)
...
Mixer_grinder_df.to_csv('Mixer_grinder.csv', encoding = 'utf-8-sig') 
files.download('Mixer_grinder.csv')

# Creating json format

from google.colab import files
Mixer_grinder_df.to_json('Mixer_grinder.json') 
files.download('Mixer_grinder.json')
