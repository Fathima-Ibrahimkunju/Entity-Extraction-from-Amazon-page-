...
d = {'Name': [], 'Price': [], 'Rating': [], 'No_of_rating': [], 'Brand': [], 'Model': [], 'Screen_size': [],
     'Colour': [], 'CPU_model': [], 'RAM_size': [], 'Operating_system': [], 'Special_feature': [],
     'Graphics_card_description': [], 'Graphics_coprocessor': [], 'Product_URL': []}
urls = []
links_list = []
for r in pages:
