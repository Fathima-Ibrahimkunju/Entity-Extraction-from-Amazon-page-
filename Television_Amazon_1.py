...
def get_mounting_hardware(soup):
    try:
        model = soup.find('tr',attrs = {'class':'a-spacing-small po-included_components'})
...
d = {'Title':[], 'Price':[], 'Rating':[], 'No_of_ratings':[],  'Screen Size':[], 'Brand':[], 'Supporting Internet Services':[], 'Display':[], 'Resolution':[],'Refresh Rate':[], 'Special Features':[],'Model Name':[], 'Mounting Hardware':[],'Connector Type':[]}
